...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:PlanDefinition">
      <sch:assert test="count(f:extension[@url = 'http://example.org/br-and-r/soa/StructureDefinition/soa-epoch-epochtype']) &lt;= 1">extension with URL = 'http://example.org/br-and-r/soa/StructureDefinition/soa-epoch-epochtype': maximum cardinality of 'extension' is 1</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
