Instance: H2Q-MC-LZZT-Study-Visit-11-1
InstanceOf: PlanDefinition
Usage: #example
Title: "Visit-11.1"
Description: "Telephone Visit [Visit-11]"
* identifier[+].value = "VISIT-11.1"
* identifier[+].value = "SE.TRT_VISIT_08-TC"
...
* action[=].id = "VISIT-11-1-H2Q-MC-LZZT-Visit-Date"
...
* action[=].relatedAction[+].actionId = "VISIT-11-1-H2Q-MC-LZZT-Visit-Date"
