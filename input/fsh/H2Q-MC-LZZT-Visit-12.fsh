...
* action[=].id = "VISIT-12-H2Q-MC-LZZT-Visit-Date"
* action[+].title = "Vital signs: Weight"
* action[=].definitionUri = "PlanDefinition/H2Q-MC-LZZT-Vital-Signs-Weight-PD"
* action[=].relatedAction[+].targetId = "VISIT-12-H2Q-MC-LZZT-Visit-Date"
...
* action[=].relatedAction[+].targetId = "VISIT-11-H2Q-MC-LZZT-Visit-Date"
* action[=].relatedAction[=].relationship = #after
