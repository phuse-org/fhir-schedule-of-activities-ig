Instance: H2Q-MC-LZZT-Study-Visit-10
InstanceOf: SOAPlanDefinition
Usage: #example
Title: "Visit-10"
Description: "Planned Visit [Visit-10]"
* identifier[+].value = "VISIT-10"
* identifier[+].value = "SE.TRT_VISIT_07"
...
* action[=].id = "VISIT-10-H2Q-MC-LZZT-Visit-Date"
...
* action[=].relatedAction[+].targetId = "VISIT-10-H2Q-MC-LZZT-Visit-Date"
