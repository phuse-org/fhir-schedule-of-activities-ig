...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Group">
      <sch:assert test="count(f:extension[@url = 'http://example.org/br-and-r/soa/StructureDefinition/SOA-arm-ResearchStudy']) &gt;= 1">extension with URL = 'http://example.org/br-and-r/soa/StructureDefinition/SOA-arm-ResearchStudy': minimum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://example.org/br-and-r/soa/StructureDefinition/SOA-arm-ResearchStudy']) &lt;= 1">extension with URL = 'http://example.org/br-and-r/soa/StructureDefinition/SOA-arm-ResearchStudy': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://example.org/br-and-r/soa/StructureDefinition/soa-arm-status']) &gt;= 1">extension with URL = 'http://example.org/br-and-r/soa/StructureDefinition/soa-arm-status': minimum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://example.org/br-and-r/soa/StructureDefinition/soa-arm-status']) &lt;= 1">extension with URL = 'http://example.org/br-and-r/soa/StructureDefinition/soa-arm-status': maximum cardinality of 'extension' is 1</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
